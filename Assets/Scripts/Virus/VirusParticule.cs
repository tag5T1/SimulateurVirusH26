...
{
    GameObject personneEmettrice;
    List<GameObject> objetsCollisionnes; // Objets que la particule a touchés
    Rigidbody rb;
    Virus virus;
    ...
    public void CréationVolatile(GameObject personne, Virus virus)
    {
        ...
        objetsCollisionnes = new List<GameObject>();
        ...
        if (objet != personneEmettrice && !objetsCollisionnes.Contains(collision.gameObject))
        {
            ...
            else
            {
                if (premiereCollision)
                {
                    ...
                    estCollee = true;
                    personneEmettrice = objet;
                }
            }

            objetsCollisionnes.Add(collision.gameObject);
        }
    }
}
